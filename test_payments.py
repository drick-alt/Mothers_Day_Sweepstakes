...
chk("mock payments disabled by default", payments.MOCK_MODE, False)
chk("unconfigured card method not ready", payments.method_ready("card"), False)
chk("manual cash method remains ready", payments.method_ready("cash"), True)
